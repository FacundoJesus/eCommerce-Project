...
public class CategoryController {
    ...
    @Operation(summary = "Get All Categories", description = "API to get all categories") // Swagger: Swagger: summario
                                                                                          // y descripcion
    ...
    public ResponseEntity<CategoryDTO> deleteCategory(
            @Parameter(description = "ID of the Category that you wish to delete") @PathVariable Long categoryId) {
